...
/**
 * Функция служит для проверки, является ли год високосным, возвращает логическое значение
...
fun daysInMonth(month: Int, year: Int): Int {
    return when (month) {
        1 -> 31; 2 -> if (isLeapYear(year)) 29 else 28
        3 -> 31; 4 -> 30; 5 -> 31; 6 -> 30
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean {
    ...
    return (min <= r && mid <= s) || (mid <= r && min <= s)
}
